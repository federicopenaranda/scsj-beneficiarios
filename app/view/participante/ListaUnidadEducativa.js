Ext.define('sisscsj.view.participante.ListaUnidadEducativa', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.participante.listaunidadeducativa',
    store: 'ParticipanteUnidadEducativa',
    requires: [
        'Ext.toolbar.Paging',
    ...
    initComponent: function() {
        ...
        var storeUnidadEducativa = Ext.data.StoreManager.lookup('opciones.UnidadEducativa');
        storeUnidadEducativa.load();
