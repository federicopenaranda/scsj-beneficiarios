Ext.define('sisscsj.controller.opciones.Departamento',{
   ...
   refs: [
    ...
    remove: function(record) {
        ...
        Ext.Msg.confirm('Atención', '¿Esta seguro que desea eliminar esta Departamento?. Esta acción no puede ser deshecha.', function(buttonId, text, opt) {
            if (buttonId == 'yes') {
                store.remove(record);
                store.sync({
                    /**
