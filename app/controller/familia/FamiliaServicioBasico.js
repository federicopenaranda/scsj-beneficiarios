Ext.define('sisscsj.controller.familia.FamiliaServicioBasico', {
    extend: 'sisscsj.controller.Base',
    stores: [
        'familia.FamiliaServicioBasico'
    ],
    views: [
        'familia.ListaServicioBasico',
        'familia.edit.FormServicioBasico',
        'familia.edit.WindowServicioBasico'
    ],
    refs: [
        {
            ref: 'FamiliaServicioBasicoLista',
            selector: '[xtype=familia.listaserviciobasico]'
        },
        {
            ref: 'FamiliaServicioBasicoWindow',
            selector: '[xtype=familia.edit.windowserviciobasico]'
        },
        {
            ref: 'FamiliaServicioBasicoForm',
    ...
    init: function() {
        this.listen({
            controller: {},
            component: {
                'grid[xtype=familia.listaserviciobasico]': {
                    beforerender: this.loadRecords,
                    itemdblclick: this.edit,
                    selectionchange: this.manejaBotones,
                    afterrender: this.manejaBotones
                },
                'grid[xtype=familia.listaserviciobasico] button#add': {
                    click: this.add
                },
                'grid[xtype=familia.listaserviciobasico] button#edit': {
                    click: this.edit
                },
                'grid[xtype=familia.listaserviciobasico] button#delete': {
                    click: this.remove
                },
                'window[xtype=familia.edit.windowserviciobasico] button#save': {
                    click: this.save
                },
                'window[xtype=familia.edit.windowserviciobasico] button#cancel': {
                    click: this.close
                }
            },
            global: {},
    ...
    loadRecords: function(grid, eOpts) {
        ...
        // Si se esta editando una familia filtrar el servicio básico por su ID
    ...
    manejaBotones: function ( record, index, eOpts ){
        var me = this;
        var grid = me.getFamiliaServicioBasicoLista();
    ...
    add: function(button, e, eOpts) {
        var me = this,
            record = Ext.create('sisscsj.model.familia.FamiliaServicioBasico');
        ...
        else
        {
            ...
            {
                console.log('[FamiliaServicioBasico] Error al recuperar el ID de la familia');
                return 'Error';
            }
        }
        // [FIN]
    ...
    save: function(button, e, eOpts) {
        var me = this,
                grid = me.getFamiliaServicioBasicoLista(),
                store = grid.getStore(),
    ...
    remove: function() {
        ...
        else
        {
            ...
            else
            {
                Ext.Msg.confirm({
                    title: 'Atención',
                    msg: '¿Esta seguro que desea eliminar este Servicio Básico?. Esta acción no puede ser deshecha.',
    ...
    showEditWindow: function(record) {
        var me = this,
                win = me.getFamiliaServicioBasicoWindow(),
                isNew = record.phantom;
        // if window exists, show it; otherwise, create new instance
        if (!win) {
            win = Ext.widget('familia.edit.windowserviciobasico', {
                title: isNew ? 'Añadir Servicio Básico' : 'Editar Servicio Básico'
            });
        }
        // show window
        win.show();
