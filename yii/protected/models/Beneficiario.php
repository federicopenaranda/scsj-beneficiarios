 ...
 * @property integer $fk_id_formacion
 ...
 * @property Formacion $fkIdFormacion
...
class Beneficiario extends CTQ
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('fk_id_religion, fk_id_entidad_salud, fk_id_curso, fk_id_nivel, fk_id_turno, fk_id_formacion, numero_hijo_beneficiario, trabaja_beneficiario, carnet_de_salud_beneficiario, libreta_escolar_beneficiario', 'numerical', 'integerOnly'=>true),
			array('codigo_beneficiario, primer_nombre_beneficiario, segundo_nombre_beneficiario, apellido_paterno_beneficiario, apellido_materno_beneficiario, numero_caso_beneficiario_patrocinador, numero_ninio_beneficiario_patrocinador, codigo_donante_beneficiario_patrocinador, nombre_patrocinador_beneficiario_patrocinador', 'length', 'max'=>45),
			...
			array('id_beneficiario, fk_id_religion, fk_id_entidad_salud, fk_id_curso, fk_id_nivel, fk_id_turno, fk_id_formacion, codigo_beneficiario, primer_nombre_beneficiario, segundo_nombre_beneficiario, apellido_paterno_beneficiario, apellido_materno_beneficiario, fecha_nacimiento_beneficiario, sexo_beneficiario, numero_hijo_beneficiario, fotografia_beneficiario, observacion_beneficiario, trabaja_beneficiario, carnet_de_salud_beneficiario, libreta_escolar_beneficiario, informacion_relevante_beneficiario, fecha_creacion_beneficiario, numero_caso_beneficiario_patrocinador, numero_ninio_beneficiario_patrocinador, codigo_donante_beneficiario_patrocinador, nombre_patrocinador_beneficiario_patrocinador', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fkIdFormacion' => array(self::BELONGS_TO, 'Formacion', 'fk_id_formacion'),
			...
			'evaluacionMonitoreoActors' => array(self::HAS_MANY, 'EvaluacionMonitoreoActor', 'fk_id_beneficiario'),
			...
			'beneficiarioDonantes' => array(self::HAS_MANY, 'BeneficiarioDonante', 'fk_id_beneficiario'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'fk_id_formacion' => 'Fk Id Formacion',
	...
	public function search()
	{
		...
		$criteria->compare('fk_id_formacion',$this->fk_id_formacion);
