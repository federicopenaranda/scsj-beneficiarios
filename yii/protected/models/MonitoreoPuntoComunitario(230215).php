...
class MonitoreoPuntoComunitario extends CTQ
{
	...
	public function rules()
	{
		...
		return array(
			array('fk_id_usuario, fk_id_lugar_actividad, fecha_monitoreo_punto_comunitario', 'required'),
			array('fk_id_usuario, fk_id_lugar_actividad', 'numerical', 'integerOnly'=>true),
			array('analisis_monitoreo_punto_comunitario', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_monitoreo_punto_comunitario, fk_id_usuario, fk_id_lugar_actividad, fecha_monitoreo_punto_comunitario, analisis_monitoreo_punto_comunitario', 'safe', 'on'=>'search'),
		);
	}
	...
	//REPORTES
	public function consulta1_de_rep1($id_monitoreo_punto_comunitario){
        $sql="SELECT
