...
class ResultadoMonitoreoPc extends CTQ
{
	...
	public function relations()
	{
		...
		return array(
			...
			#YO
			 'caracteristicasMonitoreoPcs'=>array(
                self::BELONGS_TO,'CaracteristicasMonitoreoPc',array('fk_id_caracteristica_monitoreo_pc'=>'id_resultado_monitoreo_pc'),'through'=>'fkIdAmbitoMonitoreoPc'
            ),
            'comments'=>array(
