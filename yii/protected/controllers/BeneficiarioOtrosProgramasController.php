...
*/
class BeneficiarioOtrosProgramasController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioOtrosProgramas.Create',
				'index'=>'application.controllers.BeneficiarioOtrosProgramas.Read',
				'update'=>'application.controllers.BeneficiarioOtrosProgramas.Update',
				'delete'=>'application.controllers.BeneficiarioOtrosProgramas.Delete',
		);
	}
}