...
*/
class BeneficiarioTrabajoController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioTrabajo.Create',
				'index'=>'application.controllers.BeneficiarioTrabajo.Read',
				'update'=>'application.controllers.BeneficiarioTrabajo.Update',
				'delete'=>'application.controllers.BeneficiarioTrabajo.Delete',
		);
	}
}