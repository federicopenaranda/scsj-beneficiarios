...
class ParametrosGeneralesController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.ParametrosGenerales.Create',
				'index'=>'application.controllers.ParametrosGenerales.Read',
				'update'=>'application.controllers.ParametrosGenerales.Update',
				'delete'=>'application.controllers.ParametrosGenerales.Delete',
		);
	}
}