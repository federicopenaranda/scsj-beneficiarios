...
class IdiomaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Idioma.Create',
				'index'=>'application.controllers.Idioma.Read',
				'update'=>'application.controllers.Idioma.Update',
				'delete'=>'application.controllers.Idioma.Delete',
		);
	}
}