...
class HistoriaSocialController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.HistoriaSocial.Create',
				'index'=>'application.controllers.HistoriaSocial.Read',
				'update'=>'application.controllers.HistoriaSocial.Update',
				'delete'=>'application.controllers.HistoriaSocial.Delete',
		);
	}
}