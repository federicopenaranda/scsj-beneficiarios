<?php
/**
 * Este es el controlador para el modelo "MarcoLogico".
 */
class MarcoLogicoController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.MarcoLogico.create',
				'index'=>'application.controllers.MarcoLogico.read',
				'update'=>'application.controllers.MarcoLogico.update',
				'delete'=>'application.controllers.MarcoLogico.delete',
		);
	}
}
