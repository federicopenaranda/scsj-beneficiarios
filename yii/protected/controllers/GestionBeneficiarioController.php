...
*/
class GestionBeneficiarioController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.GestionBeneficiario.Create',
				'index'=>'application.controllers.GestionBeneficiario.Read',
				'update'=>'application.controllers.GestionBeneficiario.Update',
				'delete'=>'application.controllers.GestionBeneficiario.Delete',
		);
	}
}