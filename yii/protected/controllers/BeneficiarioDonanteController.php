...
*/
class BeneficiarioDonanteController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioDonante.Create',
				'index'=>'application.controllers.BeneficiarioDonante.Read',
				'update'=>'application.controllers.BeneficiarioDonante.Update',
				'delete'=>'application.controllers.BeneficiarioDonante.Delete',
		);
	}
}