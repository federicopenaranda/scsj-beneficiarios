   ...
   public function run(){
		...
		if (isset($_GET['records'])) {
			...
			if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if (isset($records['fk_id_lugar_actividad']) && isset($records['fk_id_usuario']) && true){
					
					if ($model->validaFK('lugar_actividad','id_lugar_actividad',$records['fk_id_lugar_actividad'])!==false && $model->validaFK('usuario','id_usuario',$records['fk_id_usuario'])!==false){
