...
class EntidadSaludController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EntidadSalud.Create',
				'index'=>'application.controllers.EntidadSalud.Read',
				'update'=>'application.controllers.EntidadSalud.Update',
				'delete'=>'application.controllers.EntidadSalud.Delete',
		);
	}
}