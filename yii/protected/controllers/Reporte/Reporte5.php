...
*/
   public function run()
   {
		...
		if ($_GET['id'] && isset($_GET['id'])) {
			...
			$mPDF1->WriteHTML($controller->renderPartial('pdf5',array('res11'=>$res11,'res12'=>$res12,'res14'=>$res14,'res15'=>$res15,'res16'=>$res16,'res17'=>$res17,'res18'=>$res18,'res19'=>$res19,'res110'=>$res110,'res21'=>$res21/*$res211*/,'res22'=>$res22,'res23'=>$res23,'res3'=>$res3,'res31'=>$res31),true));
