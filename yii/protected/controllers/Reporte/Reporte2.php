   ...
   public function run()
   {
		...
		if ($_GET['id'] && isset($_GET['id'])) {
			...
			foreach($res21 as $r21):
				$aux=array();
				$aux['Nombre']= $r21['Nombre'];
				$aux['Parentesco']= $r21['Parentesco'];
				$aux['Edad']= $r21['Edad'];
				$aux['Responsable']= $r21['Responsable'];
				$aux['Sexo']= $r21['Sexo'];
				$aux['Grado']= $r21['Grado'];
				$aux['Grado']= $r21['Grado'];
				$aux['Tipo_de_Ocupacion']= $r21['Tipo_de_Ocupacion'];
				$aux['Ocupacion']= $r21['Tipo_de_Ocupacion'];
				$aux['Ingreso']= $r21['Ingreso'];
				$aux['Curso']= $r21['Curso'];
				$aux['Formacion']= $r21['Formacion'];
				$aux['beneficiarioTelefono']=$model->consulta1_6_de_rep2($r21['id_beneficiario']);
				$arreglo[]=$aux;
			endforeach;
			
			$mPDF1->WriteHTML($controller->renderPartial('pdf2',array('res11'=>$res11,'res12'=>$res12,'res14'=>$res14,'res15'=>$res15,'res16'=>$res16,'res17'=>$res17,'res18'=>$res18,'res19'=>$res19,'res110'=>$res110,'res21'=>$arreglo,'res3'=>$res3,'res31'=>$res31),true));
			#$mPDF1->Output();
