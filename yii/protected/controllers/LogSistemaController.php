...
class LogSistemaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.LogSistema.Create',
				'index'=>'application.controllers.LogSistema.Read',
				'update'=>'application.controllers.LogSistema.Update',
				'delete'=>'application.controllers.LogSistema.Delete',
		);
	}
}