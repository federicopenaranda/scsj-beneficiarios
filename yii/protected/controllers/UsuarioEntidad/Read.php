						...
						if(isset($_GET['sort']) && $_GET['sort']!=''){		
							...
							foreach ($filtro as $parametro) {
								...
								if($condicion="fk_id_usuario")
									$modelo=$model::model()->with('fkIdEntidad','fkIdUsuario')->filterTextoInt($condicion,$valor)->pagina($_GET['limit'],$_GET['start'])->ordenar($condisort,$valorsort)->findAll();	
								else
							...
							foreach ($filtro as $parametro) {
								...
								$valor=$parametro['value'];
								if($condicion="fk_id_usuario")
									$modelo=$model::model()->with('fkIdEntidad','fkIdUsuario')->filterTextoInt($condicion,$valor)->pagina($_GET['limit'],$_GET['start'])->findAll();					
								else
