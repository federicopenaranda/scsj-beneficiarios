	...
	public function run()
    {
        ...
        if ($error == "") {
			...
			foreach($modelo as $staff){
				$aux=array();
				$aux['id_nelson_ortiz']=$staff->id_nelson_ortiz;
				...
				$aux['fecha_nelson_ortiz']=$staff->fecha_nelson_ortiz;
				$aux['observaciones_nelson_ortiz']=$staff->observaciones_nelson_ortiz;
				$aux['motricidad_gruesa_nelson_ortiz']=$staff->motricidad_gruesa_nelson_ortiz;
				$aux['audicion_lenguaje_nelson_ortiz']=$staff->audicion_lenguaje_nelson_ortiz;
				$aux['motricidad_fina_nelson_ortiz']=$staff->motricidad_fina_nelson_ortiz;
				$aux['personal_social_nelson_ortiz']=$staff->personal_social_nelson_ortiz;
				$aux['total_nelson_ortiz']=$staff->total_nelson_ortiz;
				$aux['fecha_creacion_eval_edu_nelson_ortiz']=$staff->fecha_creacion_eval_edu_nelson_ortiz;
				//***********************************************************
