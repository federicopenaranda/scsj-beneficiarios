...
*/
class BeneficiarioEntidadController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioEntidad.Create',
				'index'=>'application.controllers.BeneficiarioEntidad.Read',
				'update'=>'application.controllers.BeneficiarioEntidad.Update',
				'delete'=>'application.controllers.BeneficiarioEntidad.Delete',
		);
	}
}