...
class TipoConsultaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.TipoConsulta.Create',
				'index'=>'application.controllers.TipoConsulta.Read',
				'update'=>'application.controllers.TipoConsulta.Update',
				'delete'=>'application.controllers.TipoConsulta.Delete',
		);
	}
}