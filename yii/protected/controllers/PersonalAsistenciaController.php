...
*/
class PersonalAsistenciaController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.PersonalAsistencia.Create',
				'index'=>'application.controllers.PersonalAsistencia.Read',
				'update'=>'application.controllers.PersonalAsistencia.Update',
				'delete'=>'application.controllers.PersonalAsistencia.Delete',
		);
	}
}