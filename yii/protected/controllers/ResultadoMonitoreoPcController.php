<?php
/**
 * Este es el controlador para el modelo "ResultadoMonitoreoPc".
 */
class ResultadoMonitoreoPcController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ResultadoMonitoreoPc.create',
				'index'=>'application.controllers.ResultadoMonitoreoPc.read',
				'update'=>'application.controllers.ResultadoMonitoreoPc.update',
				'delete'=>'application.controllers.ResultadoMonitoreoPc.delete',
		);
	}
}
