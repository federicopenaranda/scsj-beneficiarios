<?php
/**
 * Este es el controlador para el modelo "MonitoreoActor".
 */
class MonitoreoActorController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.MonitoreoActor.create',
				'index'=>'application.controllers.MonitoreoActor.read',
				'update'=>'application.controllers.MonitoreoActor.update',
				'delete'=>'application.controllers.MonitoreoActor.delete',
		);
	}
}
