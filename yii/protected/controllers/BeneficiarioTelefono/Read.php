			...
			if (isset($_GET['limit']) && $_GET['limit']>0 && is_numeric($_GET['limit']) &&
				...
				if ($error=="") {
					...
					foreach($modelo as $staff){
						$aux=array();
						$aux['id_beneficiario_telefono']			=(int)$staff->id_beneficiario_telefono;
						$aux['fk_id_beneficiario']					=(int)$staff->fk_id_beneficiario;
						$aux['numero_beneficiario_telefono']		=$staff->numero_beneficiario_telefono;
						$aux['tipo_telefono']						=$staff->tipo_telefono;
						$aux['emergencia_beneficiario_telefono']	=$staff->emergencia_beneficiario_telefono;
						//***********************************************************
