...
*/
class TipoProblematicaController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.TipoProblematica.Create',
				'index'=>'application.controllers.TipoProblematica.Read',
				'update'=>'application.controllers.TipoProblematica.Update',
				'delete'=>'application.controllers.TipoProblematica.Delete',
		);
	}
}