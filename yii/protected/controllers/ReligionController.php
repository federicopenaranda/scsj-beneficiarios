...
class ReligionController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Religion.Create',
				'index'=>'application.controllers.Religion.Read',
				'update'=>'application.controllers.Religion.Update',
				'delete'=>'application.controllers.Religion.Delete',
		);
	}
}