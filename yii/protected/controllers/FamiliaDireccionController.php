...
*/
class FamiliaDireccionController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.FamiliaDireccion.Create',
				'index'=>'application.controllers.FamiliaDireccion.Read',
				'update'=>'application.controllers.FamiliaDireccion.Update',
				'delete'=>'application.controllers.FamiliaDireccion.Delete',
		);
	}
}