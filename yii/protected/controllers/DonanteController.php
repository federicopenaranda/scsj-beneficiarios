...
class DonanteController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Donante.Create',
				'index'=>'application.controllers.Donante.Read',
				'update'=>'application.controllers.Donante.Update',
				'delete'=>'application.controllers.Donante.Delete',
		);
	}
}