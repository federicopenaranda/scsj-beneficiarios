...
class EstadoAsistenciaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EstadoAsistencia.Create',
				'index'=>'application.controllers.EstadoAsistencia.Read',
				'update'=>'application.controllers.EstadoAsistencia.Update',
				'delete'=>'application.controllers.EstadoAsistencia.Delete',
		);
	}
}