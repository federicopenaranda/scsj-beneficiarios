<?php
/**
 * Este es el controlador para el modelo "Nivel".
 */
class NivelController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Nivel.Create',
				'index'=>'application.controllers.Nivel.Read',
				'update'=>'application.controllers.Nivel.Update',
				'delete'=>'application.controllers.Nivel.Delete',
		);
	}
}
