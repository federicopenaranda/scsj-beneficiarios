<?php
/**
 * Este es el controlador para el modelo "Entidad".
 */
class EntidadController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Entidad.create',
				'index'=>'application.controllers.Entidad.read',
				'update'=>'application.controllers.Entidad.update',
				'delete'=>'application.controllers.Entidad.delete',
		);
	}
}
