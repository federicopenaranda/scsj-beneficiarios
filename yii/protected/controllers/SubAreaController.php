...
class SubAreaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.SubArea.Create',
				'index'=>'application.controllers.SubArea.Read',
				'update'=>'application.controllers.SubArea.Update',
				'delete'=>'application.controllers.SubArea.Delete',
		);
	}
}