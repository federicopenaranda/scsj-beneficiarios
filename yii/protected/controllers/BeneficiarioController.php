	...
	*/
	public function accessRules(){
		...
		return array(
			...
			array('allow',
				'actions'=>array('index','create','update','delete','fechanacimiento','gestionBeneficiario','gestionactualbeneficiario','gestionbeneficiarioactual','subir','beneficiarioProyecto','importar','datos','revisaCodigoBeneficiario'),
				'users'=>array('@'),
				),
			array('deny',
				'users'=>array('*'),
	...
	*/
	public function actions(){
		return array(
				...
				'gestionactualbeneficiario'=>'application.controllers.Beneficiario.GestionActualBeneficiario',
				'gestionbeneficiarioactual'=>'application.controllers.Beneficiario.GestionBeneficiarioActual',
				'subir'=>'application.controllers.Beneficiario.Subir',
				'beneficiarioProyecto'=>'application.controllers.Beneficiario.BeneficiarioProyecto',
				'importar'=>'application.controllers.Beneficiario.Importar',
				'revisaCodigoBeneficiario'=> 'application.controllers.Beneficiario.RevisaCodigoBeneficiario',
		);
	}
