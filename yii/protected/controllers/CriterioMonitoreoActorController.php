<?php
/**
 * Este es el controlador para el modelo "CriterioMonitoreoActor".
 */
class CriterioMonitoreoActorController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.CriterioMonitoreoActor.create',
				'index'=>'application.controllers.CriterioMonitoreoActor.read',
				'update'=>'application.controllers.CriterioMonitoreoActor.update',
				'delete'=>'application.controllers.CriterioMonitoreoActor.delete',
		);
	}
}
