...
*/
class EvalPsicologicoController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EvalPsicologico.Create',
				'index'=>'application.controllers.EvalPsicologico.Read',
				'update'=>'application.controllers.EvalPsicologico.Update',
				'delete'=>'application.controllers.EvalPsicologico.Delete',
		);
	}
}