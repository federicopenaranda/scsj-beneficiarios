<?php
/**
 * Este es el controlador para el modelo "MonitoreoPuntoComunitario".
 */
class MonitoreoPuntoComunitarioController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.MonitoreoPuntoComunitario.create',
				'index'=>'application.controllers.MonitoreoPuntoComunitario.read',
				'update'=>'application.controllers.MonitoreoPuntoComunitario.update',
				'delete'=>'application.controllers.MonitoreoPuntoComunitario.delete',
		);
	}
}
