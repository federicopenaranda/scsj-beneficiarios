...
<table width="856" height="243" border="0" class="tabla">
  ...
  <tr>
    <td height="23" colspan="4" align="left"><h2><font color="#558FA6">Datos Generales</font></h2>
      <p>
        <?php if($res11[0]['fotografia_beneficiario']!=""){?>
        <img src="images/<?= $res11[0]['fotografia_beneficiario']?>" alt="" width="60" height="60"/>
        <?php } else {?>
        <img src="images/foto.jpg" alt="" width="60" height="60"/>
        <?php }//if?>
      </span></p>
    <p>&nbsp;</p></td>
  </tr>
  <tr>
    ...
    <td width="209" rowspan="2" align="center" valign="top"><table width="200" border="0" class="tabla">
      ...
      <tr>
        ...
        <td style="border:1px solid black"><?php $i=0;foreach ($res16 as $value) {?>
          <?php if($res16[$i]['Estado_urgencia']==1)echo $res16[$i]['Telefono']." (urgente)";else echo $res16[$i]['Telefono']; ?>
          <br>
          <?php $i++;} ?></td>
      </tr>
  </table>
    ...
    <td width="203" height="118" align="center" valign="top"><table width="200" border="0" class="tabla">
      ...
      <table width="200" border="0" class="tabla">
        ...
        <tr>
          <td align="left" style="border:1px solid black">Ingreso:</td>
          <td style="border:1px solid black"><?php echo $res14[0]['Ingreso'];?></td>
        </tr>
      </table>
    <p>&nbsp;</p></td>
    <td width="207" rowspan="2" align="center" valign="top"><table width="200" border="0" class="tabla">
      ...
      <tr>
        <td width="112" align="left" style="border:1px solid black">Grado Escolar:</td>
        <td width="72" style="border:1px solid black"><?php echo $res15[0]['Grado_Escolar'];?></td>
      </tr>
      <tr>
      ...
      <tr>
        <td align="left" style="border:1px solid black">Libreta Escolar:</td>
        <td style="border:1px solid black"><?php if($res11[0]['Libreta_Escolar']==1)echo "Si tiene";else "No tiene";?></td>
      </tr>
      <tr>
       ...
       <tr>
        <td align="left" style="border:1px solid black">Formación: </td>
  ...
  <tr>
    <td align="center" valign="top"><table width="823" border="0" class="tabla">
      <tr>
        ...
        <th width="98" align="center" style="border:1px solid black">Nombre</th>
        <th width="99" align="center" style="border:1px solid black">Parentesco</th>
        <th width="49" align="center" style="border:1px solid black">Edad</th>
        <th width="54" align="center" style="border:1px solid black">Resp</th>
        ...
        <th width="75" align="center" style="border:1px solid black">Curso</th>
        <th width="75" align="center" style="border:1px solid black">Nivel</th>
        <th width="75" align="center" style="border:1px solid black">Formación</th>
         <th width="75" align="center" style="border:1px solid black">Teléfono</th>
      </tr>
      <?php for($i=0;$i<sizeof($res21);$i++) { ?>
      <tr>
        <td style="border:1px solid black"><?php echo $i+1;?></td>
        <td style="border:1px solid black"><?php echo $res21[$i]['Nombre']." ".$res21[$i]['Apellido'];?></td>
        <td style="border:1px solid black"><?php if($res21[$i]['Parentesco'] == "Hijo/a") echo "Hermano/a"; else echo $res21[$i]['Parentesco'];?></td>
        ...
        <td style="border:1px solid black"><?php echo $res21[$i]['Curso'];?></td>
        <td style="border:1px solid black"><?php echo $res21[$i]['Grado'];?></td>
        <td style="border:1px solid black"><?php echo $res21[$i]['Formacion'];?></td>
        <td style="border:1px solid black"><?php foreach ($res21[$i]['beneficiarioTelefono'] as $r21): echo $r21['Telefono']."<br>"; endforeach;?>
        </td>
      </tr>
       <?php }?>
    </table></td>
...
<table width="855" height="114" border="0" class="tabla">
  ...
  <tr>
    ...
    <td width="210" align="center" valign="top"><table width="200" border="0" class="tabla">
      <tr>
    ...
    <td colspan="2" align="center" valign="top"><table width="200" height="53" border="0" class="tabla">
      <tr>
        <th colspan="2" align="center" style="border:1px solid black">Responsable</th>
        </tr>
      <tr>
        <td width="103" height="40" align="center" style="border:1px solid black">Personal:</td>
        <td width="81" style="border:1px solid black"><p>&nbsp;</p>
          <p>&nbsp;</p></td>
      </tr>
    </table></td>
    <td width="200" align="center" valign="top"><table width="200" height="85" border="0.5" class="tabla">
      <tr>
  ...
  <tr>
    <td width="177" align="left" style="border:1px solid black">Observaciones:</td>
    <td width="50">&nbsp;</td>
    <td>&nbsp;</td>
    <td width="192" align="left" style="border:1px solid black">Información Relevantes:</td>
    <td width="2"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td height="25" colspan="3" align="left" style="border:1px solid black"><?php echo $res3[0]['Observaciones'];?></td>
    <td colspan="3" align="left" style="border:1px solid black"><?php echo $res3[0]['Informacion_relevante'];?></td>
  </tr>
</table>
<p>&nbsp;</p>
<p>&nbsp;</p>
