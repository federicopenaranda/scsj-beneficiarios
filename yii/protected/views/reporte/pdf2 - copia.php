...
<table width="856" height="243" border="0" class="tabla">
  ...
  <tr>
    <td height="23" colspan="4" align="left"><h2><font color="#558FA6">Datos Generales</font></h2>
      <p><span style="border:1px solid black"><?php if(isset($res11[0]['fotografia_beneficiario'])){?><img src="images/<?= $res11[0]['fotografia_beneficiario']?>" alt="" width="60" height="60"/><?php } else {?><img src="images/foto.jpg" alt="" width="60" height="60"/> <?php }//if?></span></p>
      <p>&nbsp;</p>
    <p>&nbsp;</p></td>
  </tr>
  <tr>
