...
*/
class EntidadEstadoEntidadController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EntidadEstadoEntidad.Create',
				'index'=>'application.controllers.EntidadEstadoEntidad.Read',
				'update'=>'application.controllers.EntidadEstadoEntidad.Update',
				'delete'=>'application.controllers.EntidadEstadoEntidad.Delete',
		);
	}
}