    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_vacuna']) && isset($records['nombre_vacuna']) && isset($records['descripcion_vacuna']) && isset($records['estado_vacuna']) && true){
					...
					$model=Vacuna::model()->findByPk($records['id_vacuna']);
					if($model!==null){
