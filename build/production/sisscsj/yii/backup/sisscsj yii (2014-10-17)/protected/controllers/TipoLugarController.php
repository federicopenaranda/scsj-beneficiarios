...
class TipoLugarController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.TipoLugar.Create',
				'index'=>'application.controllers.TipoLugar.Read',
				'update'=>'application.controllers.TipoLugar.Update',
				'delete'=>'application.controllers.TipoLugar.Delete',
		);
	}
}