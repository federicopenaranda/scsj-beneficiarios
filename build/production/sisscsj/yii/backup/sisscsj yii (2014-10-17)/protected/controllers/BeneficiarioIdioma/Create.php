   ...
   public function run()
   {
		...
		if (isset($_GET['records'])) {
			...
			if (isset($_GET['callback']) && $_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if (isset($records['fk_id_idioma']) && isset($records['fk_id_beneficiario'])){
					
					if ($model->validaFK('idioma','id_idioma',$records['fk_id_idioma'])!==false && $model->validaFK('beneficiario','id_beneficiario',$records['fk_id_beneficiario'])!==false){
