...
*/
class EdadesBeneficiarioController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EdadesBeneficiario.Create',
				'index'=>'application.controllers.EdadesBeneficiario.Read',
				'update'=>'application.controllers.EdadesBeneficiario.Update',
				'delete'=>'application.controllers.EdadesBeneficiario.Delete',
		);
	}
}