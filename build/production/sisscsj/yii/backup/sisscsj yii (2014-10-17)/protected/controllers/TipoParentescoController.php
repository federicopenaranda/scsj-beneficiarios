<?php
/**
 * Este es el controlador para el modelo "TipoParentesco".
 */
class TipoParentescoController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.TipoParentesco.Create',
				'index'=>'application.controllers.TipoParentesco.Read',
				'update'=>'application.controllers.TipoParentesco.Update',
				'delete'=>'application.controllers.TipoParentesco.Delete',
		);
	}
}
