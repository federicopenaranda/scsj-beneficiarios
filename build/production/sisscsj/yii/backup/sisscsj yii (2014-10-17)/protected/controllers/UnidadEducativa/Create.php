		...
		if (isset($_GET['records'])){
			...
			if(json_last_error()==JSON_ERROR_NONE){
				...
				if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
					...
					if (isset($records['nombre_unidad_educativa']) && isset($records['telefono_unidad_educativa']) && isset($records['direccion_unidad_educativa']) && true){
						...
						//***************************
						$listaRelaciones= array('beneficiario_unidad_educativa'=>'BeneficiarioUnidadEducativa',
											);
						$contNotNull=0;
