		...
		if (isset($_GET['records'])) {
			...
			if (json_last_error()==JSON_ERROR_NONE) {
				...
				if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
					...
					if (isset($records['nombre_ocupacion']) && isset($records['descripcion_ocupacion']) && true){
						$model->nombre_ocupacion=$records['nombre_ocupacion'];
						$model->descripcion_ocupacion=$records['descripcion_ocupacion'];
						//*********************************************************
						$listaRelaciones= array('beneficiario_ocupacion'=>'BeneficiarioOcupacion',
											);
						$contNotNull=0;
