    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_beneficiario_entidad']) && isset($records['fk_id_beneficiario']) && isset($records['fk_id_entidad']) && isset($records['fecha_vinculacion_beneficiario_entidad']) && isset($records['fecha_retiro_beneficiario_entidad']) && isset($records['razon_retiro_beneficiario']) && isset($records['estado_beneficiario_entidad']) && true){
