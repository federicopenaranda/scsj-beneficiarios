		...
		if (isset($_GET['records'])) {
			...
			if (json_last_error()==JSON_ERROR_NONE) {
				...
				if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
					...
					if (isset($records['nombre_estado_entidad']) && isset($records['descripcion_estado_entidad']) && true){
						$model->nombre_estado_entidad=$records['nombre_estado_entidad'];
						$model->descripcion_estado_entidad=$records['descripcion_estado_entidad'];
						
						//***************************
						$listaRelaciones= array('entidad_estado_entidad'=>'EntidadEstadoEntidad',
											);
						$contNotNull=0;
