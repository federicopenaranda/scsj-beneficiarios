...
class PatrocinadorController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Patrocinador.Create',
				'index'=>'application.controllers.Patrocinador.Read',
				'update'=>'application.controllers.Patrocinador.Update',
				'delete'=>'application.controllers.Patrocinador.Delete',
		);
	}
}