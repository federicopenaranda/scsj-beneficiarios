...
relacion 3				if(isset($records['id_beneficiario']) && is_numeric($records['id_beneficiario']) && $records['id_beneficiario']>0){				
					$model=Beneficiario::model()->deleteByPk($records['id_beneficiario']);
					if($model==1){
