...
class SectorController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Sector.Create',
				'index'=>'application.controllers.Sector.Read',
				'update'=>'application.controllers.Sector.Update',
				'delete'=>'application.controllers.Sector.Delete',
		);
	}
}