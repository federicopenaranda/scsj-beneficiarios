...
*/
class ActividadTipoActividadController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.ActividadTipoActividad.Create',
				'index'=>'application.controllers.ActividadTipoActividad.Read',
				'update'=>'application.controllers.ActividadTipoActividad.Update',
				'delete'=>'application.controllers.ActividadTipoActividad.Delete',
		);
	}
}