...
class VacunaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Vacuna.Create',
				'index'=>'application.controllers.Vacuna.Read',
				'update'=>'application.controllers.Vacuna.Update',
				'delete'=>'application.controllers.Vacuna.Delete',
		);
	}
}