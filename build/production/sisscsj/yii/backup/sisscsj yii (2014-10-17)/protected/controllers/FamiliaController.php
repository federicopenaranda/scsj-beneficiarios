...
class FamiliaController extends Controller{
	...
	*/
	public function accessRules(){
		return array(
			...
			array('allow',
				'actions'=>array('index','create','update','delete','familiaMiembros'),
				'users'=>array('*'),
				),
			array('deny',
				'users'=>array('*'),
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Familia.Create',
				'index'=>'application.controllers.Familia.Read',
				'update'=>'application.controllers.Familia.Update',
				'delete'=>'application.controllers.Familia.Delete',
				'familiaMiembros'=>'application.controllers.Familia.FamiliaMiembros',
		);
	}
}