...
*/
class BeneficiarioOcupacionController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioOcupacion.Create',
				'index'=>'application.controllers.BeneficiarioOcupacion.Read',
				'update'=>'application.controllers.BeneficiarioOcupacion.Update',
				'delete'=>'application.controllers.BeneficiarioOcupacion.Delete',
		);
	}
}