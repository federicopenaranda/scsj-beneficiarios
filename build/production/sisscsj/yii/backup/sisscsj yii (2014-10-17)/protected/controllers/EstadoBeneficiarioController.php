...
*/
class EstadoBeneficiarioController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EstadoBeneficiario.Create',
				'index'=>'application.controllers.EstadoBeneficiario.Read',
				'update'=>'application.controllers.EstadoBeneficiario.Update',
				'delete'=>'application.controllers.EstadoBeneficiario.Delete',
		);
	}
}