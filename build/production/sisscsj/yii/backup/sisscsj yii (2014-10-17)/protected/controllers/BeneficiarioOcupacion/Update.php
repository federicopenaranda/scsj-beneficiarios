    ...
    public function run(){
		...
		/*if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				$callback=$_GET['callback'];			
				if(isset($records['id_beneficiario_ocupacion']) && isset($records['fk_id_beneficiario']) && isset($records['fk_id_ocupacion']) && isset($records['fecha_beneficiario_ocupacion']) && isset($records['estado_beneficiario_ocupacion']) && isset($records['observacion_beneficiario_ocupacion']) && true){
