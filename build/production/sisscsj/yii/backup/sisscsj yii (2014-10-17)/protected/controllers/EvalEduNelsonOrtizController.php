...
*/
class EvalEduNelsonOrtizController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EvalEduNelsonOrtiz.Create',
				'index'=>'application.controllers.EvalEduNelsonOrtiz.Read',
				'update'=>'application.controllers.EvalEduNelsonOrtiz.Update',
				'delete'=>'application.controllers.EvalEduNelsonOrtiz.Delete',
		);
	}
}