...
class UsuarioEntidadController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.UsuarioEntidad.Create',
				'index'=>'application.controllers.UsuarioEntidad.Read',
				'update'=>'application.controllers.UsuarioEntidad.Update',
				'delete'=>'application.controllers.UsuarioEntidad.Delete',
		);
	}
}