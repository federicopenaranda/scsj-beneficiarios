...
class DepartamentoController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Departamento.Create',
				'index'=>'application.controllers.Departamento.Read',
				'update'=>'application.controllers.Departamento.Update',
				'delete'=>'application.controllers.Departamento.Delete',
		);
	}
}