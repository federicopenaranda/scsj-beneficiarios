   ...
   public function run()
   {
		...
		/*if (isset($_GET['records'])) {
			...
			if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if (isset($records['fk_id_unidad_educativa']) && isset($records['fk_id_beneficiario']) && isset($records['estado_beneficiario_unidad_educativa']) && true){
					...
					if ($model->validaFK('unidad_educativa','id_unidad_educativa',$records['fk_id_unidad_educativa'])!==false && 
