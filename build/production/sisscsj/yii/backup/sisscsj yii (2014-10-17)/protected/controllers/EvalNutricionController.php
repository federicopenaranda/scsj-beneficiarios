...
*/
class EvalNutricionController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EvalNutricion.Create',
				'index'=>'application.controllers.EvalNutricion.Read',
				'update'=>'application.controllers.EvalNutricion.Update',
				'delete'=>'application.controllers.EvalNutricion.Delete',
		);
	}
}