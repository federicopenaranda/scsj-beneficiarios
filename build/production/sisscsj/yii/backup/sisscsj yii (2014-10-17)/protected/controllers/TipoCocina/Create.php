		...
		if(isset($_GET['records'])){
			...
			if (json_last_error()==JSON_ERROR_NONE) {
				...
				if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
					...
					if (isset($records['nombre_tipo_cocina']) && isset($records['descripcion_tipo_cocina']) && true){
						$model->nombre_tipo_cocina=$records['nombre_tipo_cocina'];
						$model->descripcion_tipo_cocina=$records['descripcion_tipo_cocina'];
						//***************************
						$listaRelaciones= array('familia_tipo_casa'=>'FamiliaTipoCasa',
											);
						$contNotNull=0;
