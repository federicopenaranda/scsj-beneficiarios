...
class EstadoEntidadController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EstadoEntidad.Create',
				'index'=>'application.controllers.EstadoEntidad.Read',
				'update'=>'application.controllers.EstadoEntidad.Update',
				'delete'=>'application.controllers.EstadoEntidad.Delete',
		);
	}
}