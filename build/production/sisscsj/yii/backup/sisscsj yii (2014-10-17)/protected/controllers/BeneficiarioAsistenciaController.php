...
*/
class BeneficiarioAsistenciaController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioAsistencia.Create',
				'index'=>'application.controllers.BeneficiarioAsistencia.Read',
				'update'=>'application.controllers.BeneficiarioAsistencia.Update',
				'delete'=>'application.controllers.BeneficiarioAsistencia.Delete',
		);
	}
}