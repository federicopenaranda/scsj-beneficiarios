    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_servicio_basico']) && isset($records['nombre_servicio_basico']) && isset($records['descripcion_servicio_basico']) && true){
					$model=ServicioBasico::model()->findByPk($records['id_servicio_basico']);
					if($model!==null){
