    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_tipo_consulta']) && isset($records['nombre_tipo_consulta']) && isset($records['descripcion_tipo_consulta']) && true){
					$model=TipoConsulta::model()->findByPk($records['id_tipo_consulta']);
					if($model!==null){
