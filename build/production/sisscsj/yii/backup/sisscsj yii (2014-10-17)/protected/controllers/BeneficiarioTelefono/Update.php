    ...
    public function run(){
		...
		if (isset($_GET['callback']) && $_GET['callback']!=='' && !is_numeric($_GET['callback']) && isset($_GET['records'])) {
			...
			try {
				foreach ($params as $value) {
					...
					try {
						if (isset($records['id_beneficiario_telefono']) && 
							...
							$model=BeneficiarioTelefono::model()->findByPk($records['id_beneficiario_telefono']);
							if ($model!==null) {
		...
		/*if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				$callback=$_GET['callback'];			
				if(isset($records['id_beneficiario_telefono']) && isset($records['fk_id_beneficiario']) && isset($records['numero_beneficiario_telefono']) && isset($records['tipo_telefono']) && isset($records['emergencia_beneficiario_telefono']) && true){
