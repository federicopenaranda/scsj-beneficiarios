    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_tipo_actividad']) && isset($records['nombre_tipo_actividad']) && isset($records['descripcion_tipo_actividad']) && true){
					$model=TipoActividad::model()->findByPk($records['id_tipo_actividad']);
					if($model!==null){
