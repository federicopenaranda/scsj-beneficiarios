...
class TipoPatrocinadorController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.TipoPatrocinador.Create',
				'index'=>'application.controllers.TipoPatrocinador.Read',
				'update'=>'application.controllers.TipoPatrocinador.Update',
				'delete'=>'application.controllers.TipoPatrocinador.Delete',
		);
	}
}