		...
		if (isset($_GET['records'])) {
			...
			if (json_last_error()==JSON_ERROR_NONE) {
				...
				if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
					...
					if (isset($records['nombre_area_conocimiento_biblioteca']) && isset($records['descripcion_area_conocimiento_biblioteca']) && true){
						...
						$model->codigo_area_conocimiento_biblioteca=$records['codigo_area_conocimiento_biblioteca'];
						//***************************
										...
										foreach ($value as $value2) {
											...
											foreach ($listaRelaciones as $nomtab => $nommod) {
												...
												switch ($key) {
													case $nomtab:
														$obj=new $nommod();
														$obj->fk_id_area_conocimiento_biblioteca=$id;
														try{
