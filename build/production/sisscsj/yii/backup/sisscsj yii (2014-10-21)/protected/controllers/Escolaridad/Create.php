		...
		if (isset($_GET['records'])){
			...
			if (json_last_error()==JSON_ERROR_NONE) {
				...
				if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
					...
					if (isset($records['nombre_escolaridad']) && isset($records['descripcion_escolaridad']) && isset($records['turno_escolaridad']) && true){
						...
						//***************************
						$listaRelaciones= array('biblioteca'=>'Biblioteca',
