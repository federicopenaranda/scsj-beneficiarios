	...
	public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['fk_id_lugar_actividad']) && is_numeric($records['fk_id_lugar_actividad']) && $records['fk_id_lugar_actividad']>0){
					$model=UsuarioLugar::model()->deleteAll(array('condition'=>'fk_id_lugar_actividad=:fk_id_lugar_actividad and fk_id_usuario=:fk_id_usuario','params'=>array(':fk_id_lugar_actividad'=>$records['fk_id_lugar_actividad'],':fk_id_usuario'=>$records['fk_id_usuario'])));
					if($model==1){
