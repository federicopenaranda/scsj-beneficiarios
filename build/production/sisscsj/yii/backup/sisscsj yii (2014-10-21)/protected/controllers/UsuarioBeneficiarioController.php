...
*/
class UsuarioBeneficiarioController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.UsuarioBeneficiario.Create',
				'index'=>'application.controllers.UsuarioBeneficiario.Read',
				'update'=>'application.controllers.UsuarioBeneficiario.Update',
				'delete'=>'application.controllers.UsuarioBeneficiario.Delete',
		);
	}
}