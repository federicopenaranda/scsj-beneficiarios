...
class TipoEntidadController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.TipoEntidad.Create',
				'index'=>'application.controllers.TipoEntidad.Read',
				'update'=>'application.controllers.TipoEntidad.Update',
				'delete'=>'application.controllers.TipoEntidad.Delete',
		);
	}
}