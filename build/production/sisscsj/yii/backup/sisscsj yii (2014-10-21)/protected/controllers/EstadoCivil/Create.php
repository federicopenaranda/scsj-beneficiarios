		...
		if (isset($_GET['records'])) {
			...
			if (json_last_error()==JSON_ERROR_NONE) {
				...
				if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
					...
					if (isset($records['nombre_estado_civil']) && isset($records['descripcion_estado_civil']) && true){
						$model->nombre_estado_civil=$records['nombre_estado_civil'];
						$model->descripcion_estado_civil=$records['descripcion_estado_civil'];
						//*********************************************************
						$listaRelaciones= array('beneficiario_estado_civil'=>'BeneficiarioEstadoCivil',
											);
						$contNotNull=0;
