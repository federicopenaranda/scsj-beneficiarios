...
*/
class ActividadAreaActividadController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.ActividadAreaActividad.Create',
				'index'=>'application.controllers.ActividadAreaActividad.Read',
				'update'=>'application.controllers.ActividadAreaActividad.Update',
				'delete'=>'application.controllers.ActividadAreaActividad.Delete',
		);
	}
}