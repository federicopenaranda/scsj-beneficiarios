...
*/
class EvalEduChildfundController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EvalEduChildfund.Create',
				'index'=>'application.controllers.EvalEduChildfund.Read',
				'update'=>'application.controllers.EvalEduChildfund.Update',
				'delete'=>'application.controllers.EvalEduChildfund.Delete',
		);
	}
}