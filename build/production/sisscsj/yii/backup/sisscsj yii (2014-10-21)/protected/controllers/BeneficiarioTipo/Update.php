    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_beneficiario_tipo']) && isset($records['nombre_beneficiario_tipo']) && isset($records['descripcion_beneficiario_tipo']) && true){
					$model=BeneficiarioTipo::model()->findByPk($records['id_beneficiario_tipo']);
					if($model!==null){
