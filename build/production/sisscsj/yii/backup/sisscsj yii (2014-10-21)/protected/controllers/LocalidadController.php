...
class LocalidadController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Localidad.Create',
				'index'=>'application.controllers.Localidad.Read',
				'update'=>'application.controllers.Localidad.Update',
				'delete'=>'application.controllers.Localidad.Delete',
		);
	}
}