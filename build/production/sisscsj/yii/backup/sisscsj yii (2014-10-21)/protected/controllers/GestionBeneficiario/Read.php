			...
			if(isset($_GET['limit']) && $_GET['limit']>0 && is_numeric($_GET['limit'])&&isset($_GET['start']) && $_GET['start']>=0 && $_GET['start']<=$_GET['limit'] && isset($_GET['start'])&& is_numeric($_GET['start'])){
				...
				if ($error=="") {
					...
					foreach($modelo as $staff){
						$aux=array();
						$aux['id_gestion_beneficiario']				=(int)$staff->id_gestion_beneficiario;
						$aux['fk_id_beneficiario']					=(int)$staff->fk_id_beneficiario;
						$aux['fk_id_gestion']						=(int)$staff->fk_id_gestion;
						$aux['estado_gestion_beneficiario']			=(int)$staff->estado_gestion_beneficiario;
						//***********************************************************
						...
						$aux['orden_gestion']						=(int)$staff->fkIdGestion->orden_gestion;
						$arreglo[]=$aux;
					}
