    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_lugar_actividad']) && isset($records['fk_id_tipo_lugar']) && isset($records['nombre_lugar_actividad']) && isset($records['descripcion_lugar_actividad']) && true){
					$model=LugarActividad::model()->findByPk($records['id_lugar_actividad']);
					if($model!==null){
