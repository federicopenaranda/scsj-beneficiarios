...
class AsistenciaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Asistencia.Create',
				'index'=>'application.controllers.Asistencia.Read',
				'update'=>'application.controllers.Asistencia.Update',
				'delete'=>'application.controllers.Asistencia.Delete',
		);
	}
}