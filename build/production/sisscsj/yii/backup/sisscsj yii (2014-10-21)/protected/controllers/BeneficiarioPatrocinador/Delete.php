            ...
            try {
            	foreach ($listaRecords as $listaRecord) {
                    ...
                    if (json_last_error() === JSON_ERROR_NONE) {
        				...
        				$error.= (!isset($record['fk_id_patrocinador'])) ? "Variable indefinida {fk_id_patrocinador}" : "";
						if ($error == "") {
							$model=BeneficiarioPatrocinador::model()->deleteAll(array('condition'=>'fk_id_beneficiario=:fk_id_beneficiario and fk_id_patrocinador=:fk_id_patrocinador','params'=>array(':fk_id_beneficiario'=>$record['fk_id_beneficiario'],':fk_id_patrocinador'=>$record['fk_id_patrocinador'])));
