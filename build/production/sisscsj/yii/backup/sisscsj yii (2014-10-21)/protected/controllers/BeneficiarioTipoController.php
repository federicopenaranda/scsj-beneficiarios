...
class BeneficiarioTipoController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioTipo.Create',
				'index'=>'application.controllers.BeneficiarioTipo.Read',
				'update'=>'application.controllers.BeneficiarioTipo.Update',
				'delete'=>'application.controllers.BeneficiarioTipo.Delete',
		);
	}
}