		...
		if ($_GET['id'] && isset($_GET['id'])) {
			...
			for ($i=0; $i <$tam ; $i++) { 
				...
				if(sizeof($res11)!==0){
					...
					$mPDF1->AddPage();
					$mPDF1->WriteHTML($controller->renderPartial('pdf2',array('res11'=>$res11,'res12'=>$res12,'res13'=>$res13,'res14'=>$res14,'res15'=>$res15,'res16'=>$res16,'res17'=>$res17,'res18'=>$res18,'res21'=>$res21,'res22'=>$res22,'res23'=>$res23,'res3'=>$res3,'res31'=>$res31),true));
				}			
			}
