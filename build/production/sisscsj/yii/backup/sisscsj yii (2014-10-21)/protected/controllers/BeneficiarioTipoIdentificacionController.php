...
*/
class BeneficiarioTipoIdentificacionController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioTipoIdentificacion.Create',
				'index'=>'application.controllers.BeneficiarioTipoIdentificacion.Read',
				'update'=>'application.controllers.BeneficiarioTipoIdentificacion.Update',
				'delete'=>'application.controllers.BeneficiarioTipoIdentificacion.Delete',
		);
	}
}