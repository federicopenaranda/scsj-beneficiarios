    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_log_sistema']) && isset($records['fk_id_usuario']) && isset($records['accion_sistema']) && isset($records['valor_accion_sistema']) && true){
					$model=LogSistema::model()->findByPk($records['id_log_sistema']);
					if($model!==null){
