...
class TipoCocinaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.TipoCocina.Create',
				'index'=>'application.controllers.TipoCocina.Read',
				'update'=>'application.controllers.TipoCocina.Update',
				'delete'=>'application.controllers.TipoCocina.Delete',
		);
	}
}