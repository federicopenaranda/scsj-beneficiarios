    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_localidad']) && isset($records['fk_id_provincia']) && isset($records['nombre_localidad']) && isset($records['descripcion_localidad']) && true){
					$model=Localidad::model()->findByPk($records['id_localidad']);
					if($model!==null){
