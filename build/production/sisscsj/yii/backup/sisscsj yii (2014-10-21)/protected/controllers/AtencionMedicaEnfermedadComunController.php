...
*/
class AtencionMedicaEnfermedadComunController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.AtencionMedicaEnfermedadComun.Create',
				'index'=>'application.controllers.AtencionMedicaEnfermedadComun.Read',
				'update'=>'application.controllers.AtencionMedicaEnfermedadComun.Update',
				'delete'=>'application.controllers.AtencionMedicaEnfermedadComun.Delete',
		);
	}
}