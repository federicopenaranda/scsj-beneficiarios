...
class ZonaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Zona.Create',
				'index'=>'application.controllers.Zona.Read',
				'update'=>'application.controllers.Zona.Update',
				'delete'=>'application.controllers.Zona.Delete',
		);
	}
}