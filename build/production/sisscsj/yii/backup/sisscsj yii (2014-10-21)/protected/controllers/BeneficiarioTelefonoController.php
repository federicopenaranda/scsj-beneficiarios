...
*/
class BeneficiarioTelefonoController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioTelefono.Create',
				'index'=>'application.controllers.BeneficiarioTelefono.Read',
				'update'=>'application.controllers.BeneficiarioTelefono.Update',
				'delete'=>'application.controllers.BeneficiarioTelefono.Delete',
		);
	}
}