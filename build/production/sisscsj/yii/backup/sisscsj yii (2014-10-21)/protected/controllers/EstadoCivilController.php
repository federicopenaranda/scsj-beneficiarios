...
class EstadoCivilController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EstadoCivil.Create',
				'index'=>'application.controllers.EstadoCivil.Read',
				'update'=>'application.controllers.EstadoCivil.Update',
				'delete'=>'application.controllers.EstadoCivil.Delete',
		);
	}
}