    ...
    public function run(){
		...
		if(isset($_GET['records'])){
			...
			if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if(isset($records['id_odontologia']) && isset($records['fk_id_tipo_consulta']) && isset($records['fk_id_usuario']) && isset($records['fk_id_beneficiario']) && isset($records['fecha_odontologia']) && isset($records['observaciones_odontologia']) && isset($records['cpitn_odontologia']) && isset($records['higiene_odontologia']) && isset($records['indice_may_c_odontologia']) && isset($records['indice_may_p_odontologia']) && isset($records['indice_may_d_odontologia']) && isset($records['indice_may_o_odontologia']) && isset($records['indice_min_c_odontologia']) && isset($records['indice_min_e_odontologia']) && isset($records['indice_min_o_odontologia']) && true){
