			...
			if(isset($_GET['limit']) && $_GET['limit']>0 && is_numeric($_GET['limit'])&&isset($_GET['start']) && $_GET['start']>=0 && $_GET['start']<=$_GET['limit'] && isset($_GET['start'])&& is_numeric($_GET['start'])){
				...
				if ($error=="") {
					...
					foreach($modelo as $staff){
						$aux=array();
						$aux['id_odontologia']						=(int)$staff->id_odontologia;
						...
						$aux['fecha_odontologia']					=$staff->fecha_odontologia;
						$aux['observaciones_odontologia']			=$staff->observaciones_odontologia;
						$aux['cpitn_odontologia']					=(float)$staff->cpitn_odontologia;
						$aux['higiene_odontologia']					=$staff->higiene_odontologia;
						$aux['indice_may_c_odontologia']			=(float)$staff->indice_may_c_odontologia;
						$aux['indice_may_p_odontologia']			=(float)$staff->indice_may_p_odontologia;
						$aux['indice_may_d_odontologia']			=(float)$staff->indice_may_d_odontologia;
						$aux['indice_may_o_odontologia']			=(float)$staff->indice_may_o_odontologia;
						$aux['indice_min_c_odontologia']			=(float)$staff->indice_min_c_odontologia;
						$aux['indice_min_e_odontologia']			=(float)$staff->indice_min_e_odontologia;
						$aux['indice_min_o_odontologia']			=(float)$staff->indice_min_o_odontologia;
						$aux['fecha_creacion_eval_odontologia']		=$staff->fecha_creacion_eval_odontologia;
						//***********************************************************
