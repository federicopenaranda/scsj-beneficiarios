...
class TipoUsuarioController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.TipoUsuario.Create',
				'index'=>'application.controllers.TipoUsuario.Read',
				'update'=>'application.controllers.TipoUsuario.Update',
				'delete'=>'application.controllers.TipoUsuario.Delete',
		);
	}
}