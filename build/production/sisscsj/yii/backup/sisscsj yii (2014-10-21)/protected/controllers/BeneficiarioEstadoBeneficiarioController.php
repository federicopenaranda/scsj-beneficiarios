...
*/
class BeneficiarioEstadoBeneficiarioController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioEstadoBeneficiario.Create',
				'index'=>'application.controllers.BeneficiarioEstadoBeneficiario.Read',
				'update'=>'application.controllers.BeneficiarioEstadoBeneficiario.Update',
				'delete'=>'application.controllers.BeneficiarioEstadoBeneficiario.Delete',
		);
	}
}