...
class UnidadEducativaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.UnidadEducativa.Create',
				'index'=>'application.controllers.UnidadEducativa.Read',
				'update'=>'application.controllers.UnidadEducativa.Update',
				'delete'=>'application.controllers.UnidadEducativa.Delete',
		);
	}
}