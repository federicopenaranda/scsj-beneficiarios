...
class VistaCode extends CCodeModel
{
	public $connectionId='db';
	public $tablePrefix;
	public $tableName;
	public $modelClass='Controler';
	public $modelPath='application.views';
	...
	public function attributeLabels()
	{
		return array_merge(parent::attributeLabels(), array(
			...
			'modelPath'=>'Direccion de la Vista',
	...
	public function prepare()
	{
		...
		$this->files[]=new CCodeFile(
				Yii::getPathOfAlias($this->modelPath).'/reporte/pdf.php',
		...
		foreach($this->getActionIDs() as $action)
		{
			...
			if($action=="create"){
				$this->files[]=new CCodeFile(
					Yii::getPathOfAlias($this->modelPath).'/'.lcfirst($className).'/'.$action.'.php',
