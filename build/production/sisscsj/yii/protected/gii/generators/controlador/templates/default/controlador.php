...
<?php if($modelClass == "Usuario") {?>
				'login'=>'application.controllers.<?php echo $modelClass; ?>.login',
				'logout'=>'application.controllers.<?php echo $modelClass; ?>.logout',
<?php }?>
<?php if($modelClass == "PrivilegiosUsuario") {?>
				'insert'=>'application.controllers.<?php echo $modelClass; ?>.insert',
<?php }?>
		);
	}
}
