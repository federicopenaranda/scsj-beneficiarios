...
");
?>
<h1>Generador de Modelo (ExtJs)</h1>

<p>Este generador genera modelos para una tabla especifica de la base de datos, solo genera archivos para el framework ExtJs.</p>
