...
");
?>
<h1>Generador de Controlador Patron N° 1.1 (ExtJs)</h1>

<p>Este generador genera controlador para el patron 1.1, solo genera archivos para el framework ExtJs.</p>
