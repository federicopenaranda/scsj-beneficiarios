...
*/
class EvalAtencionMedicaController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EvalAtencionMedica.Create',
				'index'=>'application.controllers.EvalAtencionMedica.Read',
				'update'=>'application.controllers.EvalAtencionMedica.Update',
				'delete'=>'application.controllers.EvalAtencionMedica.Delete',
		);
	}
}