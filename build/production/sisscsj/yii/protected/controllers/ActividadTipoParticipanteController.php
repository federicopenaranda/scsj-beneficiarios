<?php
/**
 * Este es el controlador para el modelo "ActividadTipoParticipante".
 */
class ActividadTipoParticipanteController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ActividadTipoParticipante.create',
				'index'=>'application.controllers.ActividadTipoParticipante.read',
				'update'=>'application.controllers.ActividadTipoParticipante.update',
				'delete'=>'application.controllers.ActividadTipoParticipante.delete',
		);
	}
}
