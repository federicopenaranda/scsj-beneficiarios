...
*/
class BeneficiarioIdiomaController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioIdioma.Create',
				'index'=>'application.controllers.BeneficiarioIdioma.Read',
				'update'=>'application.controllers.BeneficiarioIdioma.Update',
				'delete'=>'application.controllers.BeneficiarioIdioma.Delete',
		);
	}
}