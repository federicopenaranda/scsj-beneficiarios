				...
				try {
					if(isset($_GET['filter']) && $_GET['filter']!=''){
						...
						if(isset($_GET['sort']) && $_GET['sort']!=''){		
							...
							$modelo=$model::model()->with('fkIdBeneficiario','fkIdEstadoCivil')->findAll(array("condition"=>$condi,"order"=>$condisort." ".$valorsort,'limit'=>$_GET['limit'],'offset'=>$_GET['start']));	
						} else {
							foreach ($filtro as $parametro) {
								$condicion=$parametro['property'];
								$valor=$parametro['value'];
							...
							$modelo=$model::model()->with('fkIdBeneficiario','fkIdEstadoCivil')->pagina($_GET['limit'],$_GET['start'])->findAll($condi);							
						}
						$total="".sizeof($modelo);	
					} else {
