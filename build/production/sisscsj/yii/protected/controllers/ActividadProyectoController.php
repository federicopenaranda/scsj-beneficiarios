<?php
/**
 * Este es el controlador para el modelo "ActividadProyecto".
 */
class ActividadProyectoController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ActividadProyecto.create',
				'index'=>'application.controllers.ActividadProyecto.read',
				'update'=>'application.controllers.ActividadProyecto.update',
				'delete'=>'application.controllers.ActividadProyecto.delete',
		);
	}
}
