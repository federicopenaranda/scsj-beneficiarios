...
class EscolaridadController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Escolaridad.Create',
				'index'=>'application.controllers.Escolaridad.Read',
				'update'=>'application.controllers.Escolaridad.Update',
				'delete'=>'application.controllers.Escolaridad.Delete',
		);
	}
}