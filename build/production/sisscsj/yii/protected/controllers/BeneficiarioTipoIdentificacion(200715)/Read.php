						...
						if(isset($_GET['sort']) && $_GET['sort']!=''){		
							...
							foreach ($filtro as $parametro) {
								...
								if($condicion == "fk_id_beneficiario")
									$modelo=$model::model()->with('fkIdBeneficiario','fkIdIdentificacion')->filterTextoInt($condicion,$valor)->pagina($_GET['limit'],$_GET['start'])->ordenar($condisort,$valorsort)->findAll();
								else
							...
							foreach ($filtro as $parametro) {
								...
								$valor=$parametro['value'];
								if($condicion == "fk_id_beneficiario")
									$modelo = $model::model()->with('fkIdBeneficiario','fkIdIdentificacion')->filterTextoInt($condicion,$valor)->pagina($_GET['limit'],$_GET['start'])->findAll();	
								else
