<?php
/**
 * Este es el controlador para el modelo "TipoMonitoreoActor".
 */
class TipoMonitoreoActorController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.TipoMonitoreoActor.create',
				'index'=>'application.controllers.TipoMonitoreoActor.read',
				'update'=>'application.controllers.TipoMonitoreoActor.update',
				'delete'=>'application.controllers.TipoMonitoreoActor.delete',
		);
	}
}
