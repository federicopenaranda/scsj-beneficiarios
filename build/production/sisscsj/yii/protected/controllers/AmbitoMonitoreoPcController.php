<?php
/**
 * Este es el controlador para el modelo "AmbitoMonitoreoPc".
 */
class AmbitoMonitoreoPcController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.AmbitoMonitoreoPc.create',
				'index'=>'application.controllers.AmbitoMonitoreoPc.read',
				'update'=>'application.controllers.AmbitoMonitoreoPc.update',
				'delete'=>'application.controllers.AmbitoMonitoreoPc.delete',
		);
	}
}
