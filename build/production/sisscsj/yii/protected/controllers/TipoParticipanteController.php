<?php
/**
 * Este es el controlador para el modelo "TipoParticipante".
 */
class TipoParticipanteController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.TipoParticipante.create',
				'index'=>'application.controllers.TipoParticipante.read',
				'update'=>'application.controllers.TipoParticipante.update',
				'delete'=>'application.controllers.TipoParticipante.delete',
		);
	}
}
