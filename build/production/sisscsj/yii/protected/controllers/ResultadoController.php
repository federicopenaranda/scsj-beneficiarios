<?php
/**
 * Este es el controlador para el modelo "Resultado".
 */
class ResultadoController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Resultado.create',
				'index'=>'application.controllers.Resultado.read',
				'update'=>'application.controllers.Resultado.update',
				'delete'=>'application.controllers.Resultado.delete',
		);
	}
}
