...
class BibliotecaController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Biblioteca.Create',
				'index'=>'application.controllers.Biblioteca.Read',
				'update'=>'application.controllers.Biblioteca.Update',
				'delete'=>'application.controllers.Biblioteca.Delete',
		);
	}
}