...
*/
class BeneficiarioPatrocinadorController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioPatrocinador.Create',
				'index'=>'application.controllers.BeneficiarioPatrocinador.Read',
				'update'=>'application.controllers.BeneficiarioPatrocinador.Update',
				'delete'=>'application.controllers.BeneficiarioPatrocinador.Delete',
		);
	}
}