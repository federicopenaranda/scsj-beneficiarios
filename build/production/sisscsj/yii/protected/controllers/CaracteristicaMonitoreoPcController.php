<?php
/**
 * Este es el controlador para el modelo "CaracteristicaMonitoreoPc".
 */
class CaracteristicaMonitoreoPcController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.CaracteristicaMonitoreoPc.create',
				'index'=>'application.controllers.CaracteristicaMonitoreoPc.read',
				'update'=>'application.controllers.CaracteristicaMonitoreoPc.update',
				'delete'=>'application.controllers.CaracteristicaMonitoreoPc.delete',
		);
	}
}
