...
*/
class FamiliaTipoCasaController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.FamiliaTipoCasa.Create',
				'index'=>'application.controllers.FamiliaTipoCasa.Read',
				'update'=>'application.controllers.FamiliaTipoCasa.Update',
				'delete'=>'application.controllers.FamiliaTipoCasa.Delete',
		);
	}
}