...
*/
class FamiliaServicioBasicoController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.FamiliaServicioBasico.Create',
				'index'=>'application.controllers.FamiliaServicioBasico.Read',
				'update'=>'application.controllers.FamiliaServicioBasico.Update',
				'delete'=>'application.controllers.FamiliaServicioBasico.Delete',
		);
	}
}