...
*/
class TipoCasaController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.TipoCasa.Create',
				'index'=>'application.controllers.TipoCasa.Read',
				'update'=>'application.controllers.TipoCasa.Update',
				'delete'=>'application.controllers.TipoCasa.Delete',
		);
	}
}