...
*/
class EventoVitalFamiliaController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EventoVitalFamilia.Create',
				'index'=>'application.controllers.EventoVitalFamilia.Read',
				'update'=>'application.controllers.EventoVitalFamilia.Update',
				'delete'=>'application.controllers.EventoVitalFamilia.Delete',
		);
	}
}