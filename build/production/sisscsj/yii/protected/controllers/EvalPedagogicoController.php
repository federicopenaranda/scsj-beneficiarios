...
*/
class EvalPedagogicoController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EvalPedagogico.Create',
				'index'=>'application.controllers.EvalPedagogico.Read',
				'update'=>'application.controllers.EvalPedagogico.Update',
				'delete'=>'application.controllers.EvalPedagogico.Delete',
		);
	}
}