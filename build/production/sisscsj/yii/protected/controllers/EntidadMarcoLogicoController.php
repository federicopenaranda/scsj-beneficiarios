<?php
/**
 * Este es el controlador para el modelo "EntidadMarcoLogico".
 */
class EntidadMarcoLogicoController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.EntidadMarcoLogico.create',
				'index'=>'application.controllers.EntidadMarcoLogico.read',
				'update'=>'application.controllers.EntidadMarcoLogico.update',
				'delete'=>'application.controllers.EntidadMarcoLogico.delete',
		);
	}
}
