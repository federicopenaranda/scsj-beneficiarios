						...
						if(isset($_GET['sort']) && $_GET['sort']!=''){		
							...
							foreach ($filtro as $parametro) {
								...
								if($condicion=="fk_id_familia")
									$modelo=$model::model()->with('fkIdFamilia','fkIdServicioBasico')->filterTextoInt($condicion,$valor)->pagina($_GET['limit'],$_GET['start'])->ordenar($condisort,$valorsort)->findAll();
								else
							...
							foreach ($filtro as $parametro) {
								...
								$valor=$parametro['value'];
								if($condicion=="fk_id_familia")
									$modelo=$model::model()->with('fkIdFamilia','fkIdServicioBasico')->filterTextoInt($condicion,$valor)->pagina($_GET['limit'],$_GET['start'])->findAll();
								else
