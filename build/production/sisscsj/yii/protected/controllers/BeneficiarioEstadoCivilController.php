...
*/
class BeneficiarioEstadoCivilController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.BeneficiarioEstadoCivil.Create',
				'index'=>'application.controllers.BeneficiarioEstadoCivil.Read',
				'update'=>'application.controllers.BeneficiarioEstadoCivil.Update',
				'delete'=>'application.controllers.BeneficiarioEstadoCivil.Delete',
		);
	}
}