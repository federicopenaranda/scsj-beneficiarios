...
*/
class EvalOdontologiaController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.EvalOdontologia.Create',
				'index'=>'application.controllers.EvalOdontologia.Read',
				'update'=>'application.controllers.EvalOdontologia.Update',
				'delete'=>'application.controllers.EvalOdontologia.Delete',
		);
	}
}