<?php
/**
 * Este es el controlador para el modelo "CompetenciaMonitoreoActor".
 */
class CompetenciaMonitoreoActorController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.CompetenciaMonitoreoActor.create',
				'index'=>'application.controllers.CompetenciaMonitoreoActor.read',
				'update'=>'application.controllers.CompetenciaMonitoreoActor.update',
				'delete'=>'application.controllers.CompetenciaMonitoreoActor.delete',
		);
	}
}
