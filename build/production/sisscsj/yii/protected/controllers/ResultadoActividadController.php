<?php
/**
 * Este es el controlador para el modelo "ResultadoActividad".
 */
class ResultadoActividadController extends Controller
{
	/**
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ResultadoActividad.create',
				'index'=>'application.controllers.ResultadoActividad.read',
				'update'=>'application.controllers.ResultadoActividad.update',
				'delete'=>'application.controllers.ResultadoActividad.delete',
		);
	}
}
