...
class ServicioBasicoController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.ServicioBasico.Create',
				'index'=>'application.controllers.ServicioBasico.Read',
				'update'=>'application.controllers.ServicioBasico.Update',
				'delete'=>'application.controllers.ServicioBasico.Delete',
		);
	}
}