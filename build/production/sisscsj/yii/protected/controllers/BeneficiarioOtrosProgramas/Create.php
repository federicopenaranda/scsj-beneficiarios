   ...
   public function run(){
		...
		if (isset($_GET['records'])) {
			...
			if (isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
				...
				if (isset($records['fk_id_beneficiario']) && isset($records['fk_id_otros_programas']) && true){
					
					if ($model->validaFK('beneficiario','id_beneficiario',$records['fk_id_beneficiario'])!==false && 
						$model->validaFK('otros_programas','id_otros_programas',$records['fk_id_otros_programas'])!==false
						) {
