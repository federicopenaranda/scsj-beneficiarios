...
class OcupacionController extends Controller{
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Ocupacion.Create',
				'index'=>'application.controllers.Ocupacion.Read',
				'update'=>'application.controllers.Ocupacion.Update',
				'delete'=>'application.controllers.Ocupacion.Delete',
		);
	}
}