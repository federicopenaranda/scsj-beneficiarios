<?php
/**
 * Este es el controlador para el modelo "Parentesco".
 */
class ParentescoController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Parentesco.Create',
				'index'=>'application.controllers.Parentesco.Read',
				'update'=>'application.controllers.Parentesco.Update',
				'delete'=>'application.controllers.Parentesco.Delete',
		);
	}
}
