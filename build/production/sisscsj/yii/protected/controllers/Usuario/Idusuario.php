...
*/ 
class Idusuario extends CAction
{
/**
	...
	public function run()
	{
		...
		if(isset($_GET['callback'])&&$_GET['callback']!=='' && !is_numeric($_GET['callback'])){
			$callback=$_GET['callback'];
				...
				$Criteria->join='INNER JOIN usuario_entidad AS ue ON ue.fk_id_usuario = t.id_usuario';
				$Criteria->condition="ue.fk_id_entidad in (SELECT ue.fk_id_entidad
							FROM	usuario AS u
							INNER JOIN usuario_entidad AS ue ON ue.fk_id_usuario = u.id_usuario
							WHERE u.id_usuario = 1 AND
							ue.estado_usuario_entidad = ".Yii::app()->user->id."
							)
							AND id_usuario!=1";
