...
*/
class LugarActividadController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.LugarActividad.Create',
				'index'=>'application.controllers.LugarActividad.Read',
				'update'=>'application.controllers.LugarActividad.Update',
				'delete'=>'application.controllers.LugarActividad.Delete',
		);
	}
}