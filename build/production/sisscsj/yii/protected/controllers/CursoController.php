<?php
/**
 * Este es el controlador para el modelo "Curso".
 */
class CursoController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Curso.Create',
				'index'=>'application.controllers.Curso.Read',
				'update'=>'application.controllers.Curso.Update',
				'delete'=>'application.controllers.Curso.Delete',
		);
	}
}
