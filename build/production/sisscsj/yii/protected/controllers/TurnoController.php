<?php
/**
 * Este es el controlador para el modelo "Turno".
 */
class TurnoController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.Turno.Create',
				'index'=>'application.controllers.Turno.Read',
				'update'=>'application.controllers.Turno.Update',
				'delete'=>'application.controllers.Turno.Delete',
		);
	}
}
