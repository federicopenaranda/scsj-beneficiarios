<?php
/**
 * Este es el controlador para el modelo "ObjetivoGeneral".
 */
class ObjetivoGeneralController extends Controller
{
	...
	*/
    ...
    {
		return array(
				'create'=>'application.controllers.ObjetivoGeneral.create',
				'index'=>'application.controllers.ObjetivoGeneral.read',
				'update'=>'application.controllers.ObjetivoGeneral.update',
				'delete'=>'application.controllers.ObjetivoGeneral.delete',
		);
	}
}
