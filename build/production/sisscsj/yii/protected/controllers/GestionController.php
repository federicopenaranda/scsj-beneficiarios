...
class GestionController extends Controller{
	...
	*/
	public function accessRules(){
		return array(
			...
			array('allow',
				'actions'=>array('index','create','update','delete','lista'),
				'users'=>array('*'),
				),
			array('deny',
				'users'=>array('*'),
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.Gestion.Create',
				'index'=>'application.controllers.Gestion.Read',
				'update'=>'application.controllers.Gestion.Update',
				'delete'=>'application.controllers.Gestion.Delete',
				'lista'=>'application.controllers.Gestion.Lista',
		);
	}
}