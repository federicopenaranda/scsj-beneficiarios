...
*/
class UsuarioLugarController extends Controller{
	/**
	...
	*/
	public function actions(){
		return array(
				'create'=>'application.controllers.UsuarioLugar.Create',
				'index'=>'application.controllers.UsuarioLugar.Read',
				'update'=>'application.controllers.UsuarioLugar.Update',
				'delete'=>'application.controllers.UsuarioLugar.Delete',
		);
	}
}