	...
	public function run()
    {
        ...
        if ($error == "") {
			...
			foreach($modelo as $staff){
				$aux=array();
				$aux['id_beneficiario_patrocinador']					=$staff->id_beneficiario_patrocinador;
				...
				$aux['nombre_patrocinador_beneficiario_patrocinador']	=$staff->nombre_patrocinador_beneficiario_patrocinador;
				//***********************************************************
