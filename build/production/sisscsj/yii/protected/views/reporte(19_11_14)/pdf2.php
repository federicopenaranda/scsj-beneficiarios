  ...
  <tr>
    <td width="209" rowspan="2" align="center" valign="top"><table width="200" border="0">
      ...
      <tr>
        ...
        <td style="border:1px solid black"><?php echo $res18[0]['CI'];?></td>
      </tr>
      <tr>
    ...
    <td width="209" rowspan="2" align="center" valign="top"><table width="200" border="0" class="tabla">
      ...
      <tr>
        ...
        <tr>
          <td width="112" style="border:1px solid black">Cert.Nacimiento:</td>
          <td width="72" style="border:1px solid black"><?php echo $res[0]['Cert_de_Nacimiento'];?></td>
        </tr>
        <tr>
          <td style="border:1px solid black">Carnet de Salud:</td>
          <td style="border:1px solid black"><?php if($res[0]['Carnet_de_Salud']==1)echo "Si tiene";else echo "No tiene";?></td>
        </tr>
    </table></td>
    <td width="203" height="118" align="center" valign="top"><table width="200" border="0" class="tabla">
      ...
      <tr>
        ...
        <td style="border:1px solid black"><?php echo $res13[0]['Nro_de_Caso'];?></td>
      </tr>
    </table></td>
    <td width="207" rowspan="2" align="center" valign="top"><table width="200" border="0" class="tabla">
      ...
      <tr>
        ...
        <td style="border:1px solid black"><?php echo $res15[0]['Unidad_Educativa'];?></td>
      </tr>
      <tr>
        <td align="left" style="border:1px solid black">Libreta Escolar:</td>
        <td style="border:1px solid black"><?php if($res[0]['Libreta_Escolar']==1)echo "Si tiene";else "No tiene";?></td>
      </tr>
      <tr>
  ...
  <tr>
    <td align="center" valign="top"><table width="823" border="0" class="tabla">
      <tr>
        ...
        <th width="119" align="center" style="border:1px solid black">Tipo de Ocupación</th>
      ...
      <tr>
        ...
        <td style="border:1px solid black"><?php echo $res22[$i]['Tipo_de_Ocupacion'];?></td>
        <td style="border:1px solid black"><?php echo $res22[$i]['Ocupacion'];?></td>
        <td style="border:1px solid black"><?php echo $res23[$i]['Ingreso'];?></td>
      </tr>
       <?php }?>
    </table></td>
  </tr>
