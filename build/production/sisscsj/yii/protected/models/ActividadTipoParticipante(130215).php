...
class ActividadTipoParticipante extends CTQ
{
	...
	public function rules()
	{
		...
		return array(
			array('fk_id_actividad_proyecto, fk_id_tipo_participante, cantidad_actividad_tipo_participante', 'required'),
			array('fk_id_actividad_proyecto, fk_id_tipo_participante, cantidad_actividad_tipo_participante', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_actividad_tipo_participante, fk_id_actividad_proyecto, fk_id_tipo_participante, cantidad_actividad_tipo_participante', 'safe', 'on'=>'search'),
		);
	}
