...
class Nivel extends CTQ
{
	...
	public function relations()
	{
		...
		return array(
			'beneficiarios' => array(self::HAS_MANY, 'Beneficiario', 'fk_id_nivel'),
			'bibliotecas' => array(self::HAS_MANY, 'Biblioteca', 'fk_id_nivel'),
		);
	}
