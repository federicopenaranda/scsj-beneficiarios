 ...
 * @property integer $fk_id_tipo_participante
 * @property integer $cantidad_actividad_tipo_participante
 *
 * The followings are the available model relations:
 * @property TipoParticipante $fkIdTipoParticipante
...
class ActividadTipoParticipante extends CTQ
{
	...
	public function rules()
	{
		...
		return array(
			array('fk_id_actividad, fk_id_tipo_participante, cantidad_actividad_tipo_participante', 'required'),
			array('fk_id_actividad, fk_id_tipo_participante, cantidad_actividad_tipo_participante', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_actividad_tipo_participante, fk_id_actividad, fk_id_tipo_participante, cantidad_actividad_tipo_participante', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'fkIdTipoParticipante' => array(self::BELONGS_TO, 'TipoParticipante', 'fk_id_tipo_participante'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'fk_id_tipo_participante' => 'Fk Id Tipo Participante',
	...
	public function search()
	{
		...
		$criteria->compare('fk_id_actividad',$this->fk_id_actividad);
		$criteria->compare('fk_id_tipo_participante',$this->fk_id_tipo_participante);
