...
class ObjetivoEspecifico extends CTQ
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('metas_objetivo_especifico, indicadores_objetivo_especifico, medios_verificacion_objetivo_especifico, supuestos_objetivo_especifico', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id_objetivo_especifico, fk_id_objetivo_general, descripcion_objetivo_especifico, metas_objetivo_especifico, indicadores_objetivo_especifico, medios_verificacion_objetivo_especifico, supuestos_objetivo_especifico', 'safe', 'on'=>'search'),
		);
	}
